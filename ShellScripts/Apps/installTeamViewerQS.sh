...
############################################################################################
##
## Script to install the latest Teamviewer Quick Support client
...
weburl="https://download.teamviewer.com/download/TeamViewerQS.dmg"                                # What is the Azure Blob Storage URL?
appname="TeamViewerQS"                                                       # The name of our App deployment script (also used for Octory monitor)
app="TeamViewerQS.app"
